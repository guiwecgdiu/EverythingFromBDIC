    ...
    while p1 is not None and p2 is not None:
           if p1.element == p2.element:
                ...
                p2 = p2.next
                 ...
                 if p1.skip is not None:
                    if p1.skip.element < p2.element and p1.skip is not None:
                        p1 = p1.skip
                    elif p1.skip.element == p2.element and p1.skip is not None:   
                        answer.append( p2.element )
                        p1 = p1.skip
                        p2 = p2.next
                    elif p1.skip.element > p2.element:    
                        p1 = p1.next
                 else:
                    p1 = p1.next        
           elif p1.element > p2.element:
                if p2.skip is not None:
                    if p2.skip.element > p1.element:
                        p2 = p2.next
                    elif p2.skip.element == p1.element:
                        answer.append( p1.element )
                        p2 = p2.skip.next
                        p1 = p1.next
                    elif p2.skip.element < p1.element:
...
if __name__=='__main__':
   ...
   time_taken1 = timeit.timeit( 'intersect_skip( list1, list2 )', number = 10, globals = globals() )
  
   print( 'Execution took {:.4f} seconds'.format( time_taken ) )
   print( 'Execution took {:.4f} seconds'.format( time_taken1 ) )
